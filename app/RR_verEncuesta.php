			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Encuestas de Satisfacción de clientes</h2>
					...
					<div class="panel-body">
						...
						<?php 
							...
							$idproyecto = $_POST["opcion"];

							$consulta=mysqli_query($conexion,"SELECT titulo FROM encuesta WHERE id_proyecto = '$idproyecto' ");                    
							 $numRegistros=mysqli_num_rows($consulta);

							 if ($numRegistros==0) {
							   echo "No se han encontrado registos para mostrar";
							...
							//Consulta a la base de datos que limita los datos a mostrar
							 $consulta2=mysqli_query($conexion,"SELECT * FROM encuesta WHERE id_proyecto = '$idproyecto' ORDER BY fecha LIMIT $inicio, $reg_por_pagina");
							...
							<section id="form" class="wrap_3">
							  <form action="RR_graficos.php" method="post">
							    <table>
							      <?php 
							       ...
							       ?>
							       <tr>
							         <td width="50"><input type="radio" name="opcion2" value="<?php echo $idres; ?>" required/></td>
							       ...
							       <tr>
							         ...
							         <input type="hidden" name="titulo" value="<?php echo $titulo;?>">
							           <input class="btn_3" type="submit" value="Resultados"></input>
							         </td>
							         <td>
