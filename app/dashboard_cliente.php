						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Mejor Vendedor</h2>
									<p class="panel-subtitle">Ventas anuales del año 2018.</p>
								</header>
						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Uso del Servidor</h2>
									<p class="panel-subtitle">Estado del uso del servidor...</p>
								</header>
								<div class="panel-body">
								...
								<div class="panel-body">
									<div class="row">
												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="JSOFT Admin" selected>SCS Admin</option>
															<option value="JSOFT Drupal" >SCS Drupal</option>
															<option value="JSOFT Wordpress" >SCS Wordpress</option>
														</select>
													</strong>
												</h2>
										...
										<div class="col-lg-4 text-center">
											<h2 class="panel-title mt-md">Metas</h2>
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												<div class="liquid-meter">
													<meter min="0" max="100" value="35" id="meterSales"></meter>
												</div>
												<div class="liquid-meter-selector" id="meterSalesSel">
													<a href="#" data-val="35" class="active">Mensual</a>
													<a href="#" data-val="28">Anual</a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Preguntas de Soporte</h4>
														<div class="info">
															<strong class="amount">320</strong>
															<span class="text-primary">(14 no leidas)</span>
														</div>
													</div>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase">(reporte)</a>
													</div>
												</div>
											</div>
										</div>
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												...
												<div class="profile-info">
													<h4 class="name text-semibold">Exson Cardona</h4>
						...
						<div class="col-xl-3 col-lg-6">
							<section class="panel panel-transparent">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Mis Estados</h2>
								</header>
								<div class="panel-body">
									<section class="panel">
										<div class="panel-body">
