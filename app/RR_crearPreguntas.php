			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="panel-body">
							...
							$idproyecto = $_POST["select_proyecto"];


							 ?>
							 <section id="form">
							 	<form action="RR_php/RR_insertarPreguntas.php" class="contact_form" method="post">
							 		
							 
							 		<h3><?php echo $titulo; ?></h3>
							 		<table>
							 			<?php 
							             //Clico for que recorre la cantidad de preguntas ingresadas
							 			for ($i=1; $i <= $preguntas; $i++) { 
							 			 ?>
							 			 <tr>
							 			 	<td>Respuesta <?php echo $i; ?>&nbsp;
							 			 	<input name ="p<?php echo $i; ?>"type="text" size = "50" maxlength="50"></td>
							 			 </tr>
							 			 <?php } ?>
							 		</table><br>
